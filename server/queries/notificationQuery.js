const createArticleNotification = `INSERT INTO article_notifications (
    article_id, created_at, post_author_id, author_id, comment) 
        VALUES ($1, $2, $3, $4, $5) RETURNING *`;
const createGifNotification = `INSERT INTO gif_notifications (
    gif_id, created_at, post_author_id, author_id, comment) 
        VALUES ($1, $2, $3, $4, $5) RETURNING *`;
const createArticleLikeNotification = `INSERT INTO article_notifications (
    article_id, created_at, post_author_id, author_id, article_like) 
        VALUES ($1, $2, $3, $4, $5) RETURNING *`;
const createGifLikeNotification = `INSERT INTO article_notifications (
    article_id, created_at, post_author_id, author_id, article_like) 
        VALUES ($1, $2, $3, $4, $5) RETURNING *`;
