...
const flag =
  'UPDATE articles SET flagged =$1, flagged_at =$2 WHERE article_id = $3 RETURNING *';

//UPDATE ARTICLE QUERY
const updateArticle =
  'UPDATE articles SET title = $1, article = $2, updated_at = $3 WHERE article_id = $4  RETURNING *';
// GET ALL ARTICLES
